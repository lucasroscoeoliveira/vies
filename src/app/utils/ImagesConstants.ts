...
export default class ImagesConstants {
    ...
    static readonly HOUSE_IMAGES = {
        ...
        SPECIFICS: {
            ...
            RESIDENCIA_BURITIS: {
                SALA: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/1-sala-buritis.jpg',
                SALA_2: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/2-sala-buritis.jpg',
                SALA_3: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/3-sala-buritis.jpg',
                COZINHA: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/4-cozinha-buritis.jpg',
                COZINHA_2: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/5-cozinha-buritis.jpg',
                CASAL: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/6-casal-buritis.jpg',
                CASAL_2: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/7-casal-buritis.jpg',
                SOLTEIRO: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/8-banheiro-buritis.jpg',
                SOLTEIRO_2: environment.baseUrl + '/images/House/Projects/3-RESIDENCIA-BURITIS/9-banheiro-buritis.jpg',
            },
            HOME_OFFICE_SAVASSI: {
            ...
            SUITE_OURO_PRETO: {
                SOLTEIRA_OURO_PRETO: environment.baseUrl + '/images/House/Projects/7-SUITE-OURO-PRETO/1-solteira-ouro-preto.jpg',
                SOLTEIRA_OURO_PRETO_2: environment.baseUrl + '/images/House/Projects/7-SUITE-OURO-PRETO/2-solteira-ouro-preto.jpg',
                BANHEIRO_OURO_PRETO: environment.baseUrl + '/images/House/Projects/7-SUITE-OURO-PRETO/3-banheiro-ouro-preto.jpg',
            },
            RESIDENCIA: {
